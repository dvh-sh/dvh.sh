/**
 * @file src/containers/software/SoftwareClient.tsx
 ...
 *
 * @description
 * Client-side software list with theme-driven title animation and skeleton loaders.
 * Extracted from src/app/(public)/software/page.tsx so the page can be a server
...
/**
 * @component SoftwareClient
 * @description Fetches and renders the categorized software list with theme-driven title animation.
 */
const SoftwareClient = () => {
