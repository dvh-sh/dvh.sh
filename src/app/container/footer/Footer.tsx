...
export const Footer = () => {
    ...
    return (
        <footer className="flex justify-center items-center py-4 text-slate-400">
            <Github />
            <p className="ml-2">&copy; dvh.sh {year}</p>
        </footer>
    );
};
