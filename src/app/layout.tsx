...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    return (
        ...
        <head>
            ...
            <meta name="description" content="Explore David’s personal portfolio showcasing skills and experience in full-stack development, with expertise in various modern technologies." />
            <meta name="keywords" content="David, Full-Stack Developer, Software Engineer, Web Development, Backend, Frontend, CSIS Student" />
            <meta name="author" content="David" />
            <meta property="og:title" content="David | Full-Stack Developer Portfolio" />
            <meta property="og:description" content="Explore David’s portfolio, highlighting his expertise in full-stack development across a range of modern technologies." />
