...
const ConnectSection = React.lazy(() => import('@container/ConnectSection'));
const SkillsSection  = React.lazy(() => import('@container/SkillsSection'));
const LazyImage      = React.lazy(() => import('@component/LazyImage'));
